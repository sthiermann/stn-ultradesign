...
- Project, work mode and requested outcome:
- Existing application revision / working-tree changes / runtime environment:
- Product actors, actual resource scopes and priority tasks:
...
## Known facts and existing decisions
...
- Existing functions and variants not depicted in the first concept, with feature IDs:
- Review artifacts to produce and intended review questions:
- Link to the resulting versioned design contract:
